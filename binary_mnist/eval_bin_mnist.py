...
if __name__ == '__main__':
    ...
    score_model = ScoreNet(
        ...
        num_res_blocks=2, dropout=0.1, time_step=0.005, time_dependent_weights=torch.load('../best_model_weights/bin_mnist/mnist.unet.time.weights.pth')
    )

    score_model.load_state_dict(torch.load('../best_model_weights/bin_mnist/mnist.unet.best.pth.bak2'))
